  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      role: 'assistant',
      content: "Hi! I'm your GRCArc AI Governance Copilot. I can help you improve governance maturity, generate policies, prioritise risks and prepare for compliance. What would you like to work on?",
  ...
  return (
    <div className="flex h-[calc(100vh-8rem)] flex-col">
      <PageHeader
        ...
        action={<Badge variant="info"><Sparkles className="h-3.5 w-3.5" /> Powered by GRCArc AI</Badge>}
      />
                    ...
                    {m.role === 'assistant' && (
                      <div className="mt-3 flex items-center gap-2 border-t border-app pt-2">
                        ...
                        <button onClick={() => {
                          ...
                          a.href = url; a.download = 'grcarc-copilot-response.txt'; a.click();
