    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-[220px_1fr]">
        ...
        <div>
          {tab === 'organisation' && (
            <Card>
              <CardHeader title="Organisation Profile" subtitle="Tell GRCArc about your business" icon={<Building2 className="h-5 w-5" />} />
          ...
          {tab === 'notifications' && (
            <Card>
              <CardHeader title="Notifications" subtitle="Choose what GRCArc tells you about" icon={<Bell className="h-5 w-5" />} />
          ...
          {tab === 'appearance' && (
            <Card>
              <CardHeader title="Appearance" subtitle="How GRCArc looks for you" icon={<Palette className="h-5 w-5" />} />
              <CardBody>
          ...
          {tab === 'api' && (
            <Card>
              <CardBody>
                <ComingSoon title="API Keys" description="Programmatic access to GRCArc is coming soon. Generate keys to integrate governance data with your tools." icon={<Key className="h-7 w-7" />} />
              </CardBody>
            </Card>
          )}
        </div>
