    ...
    <div className="min-h-screen bg-white dark:bg-[#080b16]">
      ...
      <header className="sticky top-0 z-40 border-b border-app glass">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <a href="https://ohkariku-boop.github.io/grcarc/pricing" className="text-sm font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white transition">Pricing</a>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted">
            GRCArc turns scattered governance guesswork into a clear, measured programme your leadership can trust.
          </p>
        </div>
      ...
      <section id="how" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-muted">No consultants, no spreadsheets, no jargon. GRCArc meets you where you are and walks you forward.</p>
      ...
      <footer className="border-t border-app surface">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-xs text-muted">© {new Date().getFullYear()} GRCArc. Built for founders, CIOs, CTOs and IT managers.</p>
        </div>
      </footer>
    ...
    <div className="rounded-md border border-app surface-elev p-2 shadow-card">
      <div className="rounded-md bg-paper dark:bg-navy-900/60 p-6">
        <div className="flex items-center justify-between border-b border-app pb-4">
          ...
          <span className="text-xs text-ink">grcarc.app/dashboard</span>
        </div>
